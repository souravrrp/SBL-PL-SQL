...
<html>
<head>
<title>User ID Trace Start/Stop</title>
</head>
<body bgcolor="#EFECC7">
<center>
<h2>User ID Trace Start/Stop</h2>
<hr>
<?php
...
$SIDS='select sid,serial# from v$session where username=:CLIENT';
    ...
    try {
		...
		header('Location: sessions.php');
        	...
        	$form = new HTML_Form($_SERVER['PHP_SELF'], "POST");
       		$form->addBlank(3);
        	$form->addSelect("client", 'Users:', $clts);
