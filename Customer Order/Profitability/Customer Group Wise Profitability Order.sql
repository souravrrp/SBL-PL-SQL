/* Formatted on 4/9/2023 1:05:31 PM (QP5 v5.381) */
SELECT CUSTOMER_NO,
       CUSTOMER_NAME,
       ORDER_NO,
       QTY,
                    ...
                    FROM (SELECT t.invoice_id,
                                 ...
                                 * (CASE
                                 ...
                                 t.net_curr_amount
                                     SALES_PRICE,
                                 t.vat_code,
                                 IFSAPP.STATUTORY_FEE_API.Get_Fee_Rate (
                                     'SBL',
                                     t.vat_code)
                                     vat_rate,
                                 t.vat_curr_amount
                           ...
                           WHERE     t.invoice_id = i.invoice_id
                                 ...
                                 AND IFSAPP.SALES_PART_API.Get_Catalog_Type (
                                         T.C5) =
                                     'INV'
                                 AND (    t.c10 NOT LIKE '%P'
                                      AND t.c10 NOT LIKE '%C')
                                 AND t.identity LIKE 'W0%'
                                 --AND t.identity = 'W0002789-2'
                                 --AND t.identity LIKE '%$P!{CUSTOMER_NUMBER}%'
                                 --AND i.invoice_date BETWEEN $P{FROM_DATE}  and $P{TO_DATE}
