/* Formatted on 6/13/2022 2:34:41 PM (QP5 v5.381) */
SELECT po_no,
       channel,
       order_from,
       order_to,
  ...
  FROM (SELECT pot.order_no                                    po_no,
               (CASE
                    WHEN SUBSTR (pot.order_no, 0, 2) = 'A-' and SUBSTR (pot.contract, 4, 4)!='P' THEN 'Retail'
                    WHEN SUBSTR (pot.order_no, 0, 2) = 'W-' THEN 'Wholease'
                    WHEN SUBSTR (pot.order_no, 0, 2) = 'I-' THEN 'Corp'
                    WHEN SUBSTR (pot.order_no, 0, 2) = 'A-' and SUBSTR (pot.contract, 4, 4)='P' THEN 'Service Center'
