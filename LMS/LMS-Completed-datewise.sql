...
FROM_UNIXTIME(com.timecompleted, '%d-%M-%Y %H:%i:%s') AS completed
...
AND com.timecompleted BETWEEN UNIX_TIMESTAMP(STR_TO_DATE('28-04-2022', '%d-%m-%Y %h:%i%p')) AND UNIX_TIMESTAMP(STR_TO_DATE('28-04-2023', '%d-%m-%Y %h:%i%p')+ INTERVAL 1 DAY)
