--Partial Product Receive Quantity
select R.order_no,
       R.line_no,
       R.release_no,
       R.receipt_no,
 ...
 where IFSAPP.IDENTITY_INVOICE_INFO_API.Get_Group_Id('SBL',
   ...
   and R.part_no /*in
       ('SRSM-TABLE', 'SRSM- WOODEN COVER', 'SRSM-STAND-METAL-STEEL')*/ like '%FUR-%'
   and IFSAPP.PURCHASE_ORDER_LINE_API.Get_Buy_Qty_Due(R.order_no,
                                                         R.line_no,
                                                         R.release_no) != R.qty_arrived
 order by 1, 2
