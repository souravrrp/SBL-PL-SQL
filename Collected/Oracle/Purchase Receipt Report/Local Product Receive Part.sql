...
select R.order_no,
 ...
 where IFSAPP.IDENTITY_INVOICE_INFO_API.Get_Group_Id('SBL',
                                                     R.vendor_no,
                                                     'Supplier') = '0'
   and IFSAPP.INVENTORY_PART_API.Get_Part_Product_Family('SCOM', R.part_no) not in
       ('RBOOK', 'GIFT VOUCHER')
   ...
   and (substr(R.order_no, 1, 2) like 'L-%' or substr(R.order_no, 1, 2) like 'A-%')
   /*and R.contract = 'SWHW'*/
 order by 1, 2, 3, 4
