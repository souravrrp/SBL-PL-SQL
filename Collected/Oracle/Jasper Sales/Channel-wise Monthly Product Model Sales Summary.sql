--***** Channel-wise Monthly Product Model Sales Summary
select extract(year from n.sales_date) "YEAR",
 ...
 where n.sales_price != 0
   ...
   /*and n.product_family \*= 'AIR-CONDITIONER'*\ in
       ('FURNITURE-LIVING-ROOM',
        'FURNITURE-DINING-ROOM',
        'FURNITURE-BED-ROOM',
        'FURNITURE-UTILITY')*/
 group by extract(year from n.sales_date),
          extract(month from n.sales_date),
          n.sales_channel,
          n.product_family,
          n.product_code
 order by extract(year from n.sales_date),
          extract(month from n.sales_date),
          n.sales_channel,
          n.product_family,
          n.product_code
