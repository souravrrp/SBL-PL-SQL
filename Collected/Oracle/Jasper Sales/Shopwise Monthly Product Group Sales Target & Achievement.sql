--***** Shopwise Monthly Product Group Sales Target & Achievement
SELECT B.YEAR,
       B.PERIOD,
       B.AREA_CODE,
       B.DISTRICT_CODE,
       ...
       B.TARGET_QTY,
       B.TARGET_AMOUNT,
       NVL(A.ACHIEV_QTY, 0) ACHIEV_QTY,
       NVL(A.ACHIEV_AMOUNT, 0) ACHIEV_AMOUNT
  FROM (SELECT T.YEAR,
               T.PERIOD,
               S.AREA_CODE,
               S.DISTRICT_CODE,
 ...
 WHERE B.PRODUCT_GROUP = 'WASHING MACHINE'
 ORDER BY B.YEAR,
          B.PERIOD,
