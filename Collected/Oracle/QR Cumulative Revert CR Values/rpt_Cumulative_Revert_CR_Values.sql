--Cumulative Revert CR Values –
--Run below SQL as at 2017/01/31

SELECT ifsapp.Identity_Invoice_Info_API.Get_Group_Id('SBL', t.identity, 'Customer') Customer_Group,
 ...
 WHERE ifsapp.Return_Material_Line_Api.Get_Order_No(t.rma_no, '1') IN
   ...
   and t.series_id = 'CR'
   AND ifsapp.Identity_Invoice_Info_API.Get_Group_Id('SBL', t.identity, 'Customer') in
       ('0', 'EMP', 'TDCORP')
