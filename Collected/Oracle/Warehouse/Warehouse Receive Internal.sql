...
select R.order_no,
 ...
 inner join IFSAPP.WARE_HOUSE_INFO w
    on r.contract = w.ware_house_name
 where IFSAPP.IDENTITY_INVOICE_INFO_API.Get_Group_Id('SBL',
   ...
   and ifsapp.purchase_order_line_api.Get_Demand_Order_No(R.order_no,
                                                          R.line_no,
                                                          R.release_no) is null
   /*and R.contract = 'SAOS'*/
 order by 1, 2
