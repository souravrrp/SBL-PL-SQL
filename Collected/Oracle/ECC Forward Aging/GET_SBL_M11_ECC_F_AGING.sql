create or replace function GET_SBL_M11_ECC_F_AGING(
       year_      in number,
       period_    in number,
...
begin
    ...
    if m10 > 0 and (pv - ((10 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7 - m8 - m9 - m10)) > 0 then
      m11 := round((pv - ((10 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7 - m8 - m9 - m10)) * effective_rate, 6);
    else
      m11 := 0;
    end if;
