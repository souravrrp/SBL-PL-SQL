create or replace function GET_SBL_M8_ECC_F_AGING(
       year_      in number,
       period_    in number,
...
begin
    ...
    if m7 > 0 and (pv - ((7 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7)) > 0 then
      m8 := round((pv - ((7 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7)) * effective_rate, 6);
    else
      m8 := 0;
    end if;
