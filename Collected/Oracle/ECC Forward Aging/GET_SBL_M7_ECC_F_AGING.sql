create or replace function GET_SBL_M7_ECC_F_AGING(
       year_      in number,
       period_    in number,
...
begin
    ...
    if m6 > 0 and (pv - ((6 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6)) > 0 then
      m7 := round((pv - ((6 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6)) * effective_rate, 6);
    else
      m7 := 0;
    end if;
