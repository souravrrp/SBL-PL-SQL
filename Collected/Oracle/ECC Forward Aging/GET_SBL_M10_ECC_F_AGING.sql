create or replace function GET_SBL_M10_ECC_F_AGING(
       year_      in number,
       period_    in number,
...
begin
    ...
    if m9 > 0 and (pv - ((9 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7 - m8 - m9)) > 0 then
      m10 := round((pv - ((9 * monthly_pay) - m1 - m2 - m3 - m4 - m5 - m6 - m7 - m8 - m9)) * effective_rate, 6);
    else
      m10 := 0;
    end if;
