--***** Manual COMP Sales Data Maintenance
--***** COMP Sales Accounts Delete
/*
delete from IFSAPP.SBL_JR_SALES_DTL_PKG_COMP c
 where c.sales_date = to_date('&sales_date', 'YYYY/MM/DD');
commit;
*/

--***** COMP Sales Accounts Insert
/*
begin
  insert into IFSAPP.SBL_JR_SALES_DTL_PKG_COMP
    select P.INVOICE_ID,
           P.ITEM_ID,
           P.SITE,
           P.ORDER_NO,
