--***** Customer-wise Past Due Aging
select v1.customer,
       ifsapp.customer_info_api.Get_Name(v1.customer) customer_name,
       /*ifsapp.CUSTOMER_INFO_COMM_METHOD_API.Get_Any_Phone_No(v1.customer) phone_no,
       IFSAPP.CUSTOMER_INFO_ADDRESS_API.Get_Address1(v1.customer, 1) || ' ' ||
       IFSAPP.CUSTOMER_INFO_ADDRESS_API.Get_Address2(v1.customer, 1) customer_address,*/
       v1.band,
 ...
 group by v1.customer, v1.band
 ORDER BY v1.customer, v1.band
