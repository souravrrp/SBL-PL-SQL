create or replace view sbl_return_info as
  select r.order_no, r.contract, trunc(r.date_returned) date_returned
    from ifsapp.RETURN_MATERIAL_LINE_TAB r, ifsapp.HPNRET_HP_DTL_TAB h
   where h.account_no = r.order_no
     ...
     and r.rowstate = 'ReturnCompleted'
