/* Formatted on 3/23/2023 3:16:57 PM (QP5 v5.381) */
  SELECT CUSTOMER_NO,
         CUSTOMER_NAME,
         SUM (QUANTIY)                   QTY,
         SUM (NSP)                       NSP,
         ROUND (SUM (OPERATION_COST))    OP_COST,
         ROUND (AVG (OP_PERCENT), 2)     OP_PERCENT,
         (CASE
              WHEN ROUND (SUM (OPERATION_COST)) <= 1 THEN 'Non-Profitable'
              ELSE 'Profitable'
          END)                           profitability
