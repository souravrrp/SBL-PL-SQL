/* Formatted on 6/22/2021 10:08:55 AM (QP5 v5.287) */
...
IS
   ...
   FUNCTION run_scheduler_job_func
      RETURN NUMBER
   IS
   ...
   PROCEDURE run_scheduler_job_conc (ERRBUF    OUT VARCHAR2,
   ...
   BEGIN
      ...
      L_Retcode := run_scheduler_job_func;
   ...
   END run_scheduler_job_conc;

   PROCEDURE run_scheduler_job_proc
   IS
