/* Formatted on 7/26/2021 12:21:24 PM (QP5 v5.287) */
SELECT 1 SL,
       101 APPLICATION_ID,
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (GJH.CREATED_BY) CREATED_BY,
...
SELECT 2 SL,
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (CT.CREATED_BY) CREATED_BY,
...
SELECT 4 SL,
       ...
       CT.INVOICE_CURRENCY_CODE CURRENCY_CODE,
       CT.EXCHANGE_RATE CONVERSION_RATE,
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (ADJ.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
...
SELECT 5 SL,
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (CR.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
...
SELECT 6 SL,
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (API.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
...
SELECT 7 SL,
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (APC.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
...
SELECT 10 SL,
       ...
       (SELECT DESCRIPTION
         ...
         WHERE     A.FLEX_VALUE_SET_ID = 1017041
          ...
          SUBACCDESC,
       TO_CHAR (NULL) VOUCHER_NUMBER_2,
       NVL (TO_NUMBER (APPS.XX_GET_RCV_NUMBER_FROM_TRX_ID (SOURCE_ID_INT_1)),
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (MMT.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
...
SELECT 12 SL,                                               ----ADDED BY Majid
       ...
       APPS.XX_COM_PKG.GET_EMP_NAME_FROM_USER_ID (GXEH.CREATED_BY) CREATED_BY,
       NVL (XAL.ENTERED_DR, 0) ENTERED_DEBITS,
       NVL (XAL.ENTERED_CR, 0) ENTERED_CREDITS,
       XAL.ACCOUNTED_DR,
       XAL.ACCOUNTED_CR,
