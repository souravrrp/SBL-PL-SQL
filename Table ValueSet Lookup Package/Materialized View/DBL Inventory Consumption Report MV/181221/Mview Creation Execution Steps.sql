...
GRANT SELECT ON APPS.XXDBL_INV_CON_RPT_MV# TO APPSRO;
...
BEGIN
    SYS.DBMS_SCHEDULER.create_job (
        ...
        job_action        =>
            'BEGIN EXECUTE dbms_mview.refresh(''APPS.XXDBL_INV_CON_RPT_MV'',method => ''C'',ATOMIC_REFRESH=>FALSE) END;',
...
SELECT *
 ...
 WHERE 1 = 1       --AND TO_CHAR (TRANSACTION_DATE, 'DD-MON-YY') = '01-FEB-21'
