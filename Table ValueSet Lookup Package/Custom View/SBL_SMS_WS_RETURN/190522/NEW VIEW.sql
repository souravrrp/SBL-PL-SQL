/* Formatted on 5/19/2022 12:35:30 PM (QP5 v5.381) */
CREATE OR REPLACE FORCE VIEW IFSAPP.SBL_SMS_WS_RETURN_NEW
(
    RMA_NO,
    SITE,
    ORDER_NO,
