/* Formatted on 2/2/2022 10:04:29 AM (QP5 v5.374) */
--------------------------------SEWING THREAD---------------------------
       ...
       AND NOT EXISTS
               (SELECT 1
                 ...
                 WHERE     gab.organization_id = msib.organization_id
                       ...
                       AND msib.inventory_item_id = gab.inventory_item_id) --Updated By Sourav 010222
...
SELECT *
  FROM xxdbl.xxdbl_gl_aloc_basis_upload_stg stg
 WHERE 1 = 1 AND item_code = '26S1COT0100S-50278'